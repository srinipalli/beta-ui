    ...
    <div className="w-full min-h-screen px-8 py-12 bg-gray-50">
      <div className="max-w-7xl mx-auto bg-white rounded-2xl shadow-xl p-10 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-10">
            ...
            <div>
              ...
              <p className="text-gray-700 text-lg text-justify">{ticket.ticket_summary || <em className="text-gray-400">Not available</em>}</p>
            </div>

            <div>
              <h3 className="text-sm font-semibold text-gray-900 mb-2 ">AI Suggested Solution</h3>
              <p className="text-gray-700 text-lg text-justify">{ticket.ticket_solution || <em className="text-gray-400">Not available</em>}</p>
            </div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div>
              <h3 className="text-sm font-semibold text-gray-900 mb-2">Triage Level (AI)</h3>
            ...
            <div>
              <h3 className="text-sm font-semibold text-gray-900 mb-2">AI Assigned Category</h3>
              <div className="flex items-center space-x-3">
                {editMode ? (
                    <select
        ...
        <div className="md:col-span-2">
          ...
          <p className="text-gray-700 text-lg whitespace-pre-line text-justify">
